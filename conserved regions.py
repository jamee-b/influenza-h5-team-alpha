...
def run_clustalo(input_fasta, output_fasta):
    ...
    clustal_path = r"C:\Users\brandlja\Documents\Clustal Omega\clustal-omega-1.2.2-win64\clustalo.exe"  
    try:
...
plt.title("Conserved and Variable Regions Across Segments")
